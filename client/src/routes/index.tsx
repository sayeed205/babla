        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              A modern web application with secure Telegram authentication. 
              Access your personalized dashboard and manage your content seamlessly.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Sign in with your Telegram account to access all features and your personalized dashboard.
                  </p>
                </div>
